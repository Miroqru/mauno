...
class GameRules(IntEnum):
    ...
    special_wild = 1 << 7  # "❤️ Особая дикость
    auto_choose_color = 1 << 8  # "🌷 самоцвет
    random_color = 1 << 9  # "🎲 Какой цвет
    side_effect = 1 << 10  # "💎 Побочный выброс
    intervention = 1 << 11  # "😈 Вмешательство 🔧
