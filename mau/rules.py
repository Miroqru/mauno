...
class GameRules(IntEnum):
    ...
    one_winner = 1 << 1  # "👑 Один победитель
    auto_skip = 1 << 2  # "💸 Авто пропуск
    take_until_cover = 1 << 3  # "🍷 Беру до последнего
    shotgun = 1 << 4  # "🔫 Револьвер
    deferred_take = 1 << 5  # "⏳ Отложенное взятие
    special_wild = 1 << 6  # "❤️ Особая дикость
    auto_choose_color = 1 << 7  # "🌷 самоцвет
    random_color = 1 << 8  # "🎲 Какой цвет
    side_effect = 1 << 9  # "💎 Побочный выброс
    intervention = 1 << 10  # "😈 Вмешательство 🔧
